    ...
    <b-container>
      <b-row>
        <b-col cols="12" md="7" lg="7" class="pt-5">
          <h1
            class="mt-5 mb-0 text-title text-primary title-font"
          >Crie sua própria loja e venda muito mais!</h1>
          <h6
            class="text-title text-primary pb-0 mb-0 pt-1"
          >Setup e custo para treinamento gratuito*</h6>
          <h1 class="mb-0 text-title text-success title-font">R$ 0,00</h1>
          <h6 class="text-title text-primary">*Consulte as taxas transacionais.</h6>
