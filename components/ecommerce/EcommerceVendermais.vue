    ...
    <b-container class=" pt-5 pb-5 ">
      <b-row>
        <b-col cols="12" md="12" lg="12" class="text-center pb-4">
          <h1 class="text-title text-blackdark">Solução de integração</h1>
          <h3 class="text-content">Ferramentas para sua loja.</h3>
        </b-col>
        <b-col cols="12" md="6" lg="8">
          <h1 class="text-title text-blackdark">API E-Commerce Imobanco</h1>
          <p
            class="text-content"
          >Para facilitar a integração da API, disponibilizamos a biblioteca completa para seu desenvolvedor.</p>
          <a
