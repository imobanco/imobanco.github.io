	...
	<section class="bg-info pt-4 pb-4">
		...
		<div class="row pt-4 pb-4">
            <div class="col-lg-3 col-md-6">
            	<p class="imo-text-05 text-content pt-2"><img src="~/assets/image/imobanco-branco.png" alt=""></p>
				<h5 class="text-white text-titulo mt-2 mb-2">Contate a gente</h5>
			 ...
			 <div class="col-lg-3 col-md-6">
				...
				<p class="p-0 m-0"><a href="#" class="text-white text-content text-decoration-none">E-Commerce</a></p>
				<p class="p-0 m-0"><a href="#" class="text-white text-content text-decoration-none">Soluções</a></p>
				<p class="p-0 m-0"><a href="#" class="text-white text-content text-decoration-none">Planos</a></p>
				<p class="p-0 m-0"><a href="#" class="text-white text-content text-decoration-none">Blog</a></p>
				<p class="p-0 m-0"><a href="#" class="text-white text-content text-decoration-none">Contato</a></p>
