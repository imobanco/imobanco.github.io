<template>
  <section class="pt-5 pb-2 bg-graylight">
    <b-container>
      <b-row>
        <b-col cols="12" md="6" lg="6">
          ...
          <p class="text-justify">
            ...
            departamentos do Imobanco. <br />
            <br />
            Estamos sempre disponíveis de Segunda a Sexta, das 9:00 às 16h.
          </p>
        ...
        <b-col cols="12" md="6" lg="6" class="text-center pt-3"
          ><img src="~static/image/chatcontato.png" alt="" class="img-fluid"
        /></b-col>
      </b-row>
    </b-container>
  </section>
