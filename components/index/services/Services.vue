  ...
  <div class="container-fluid bg-secondary">
    <div class="row justify-content-center pt-5 pb-5">
          <div class="col-lg-8 text-center mb-0 p-0 ml-0">
            <h3 class="mt-4 mb-0 pl-0 text-titulo text-white text-left">Serviços</h3>
            <h4 class="text-content text-success text-left mt-0 p-0">Oferecemos uma gama completa de serviços para
...
.card-top{
 border-top: 6px solid #304ffe !important;
